    ...
    (async () => {
        try {
            ...
            for(let i = 0; i < 2; i++){
                ...
                legacy[i] = {address: bitcoinAddress, format: "legacy", formatType: "LEGACY", derivationPath: derivationPath, index: i}
            }
            ...
            for(let i = 0; i < 2; i++){
                ...
                bech32[i] = {address: bitcoinAddress, format: "bech32", formatType: "NATIVE SEGWIT", derivationPath: derivationPath, index: i}
            }
...
export async function getAddressFromPathLedger(format, index, callback){ 
    ...
    (async () => {
        try {
            ...
            let message = {address: bitcoinAddress, format: format, formatType: formatType, derivationPath: derivationPath, index: index}
